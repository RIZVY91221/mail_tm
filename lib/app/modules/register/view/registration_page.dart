...
class RegistrationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var _emailSuffix = "@" + Get.arguments[PreferenceManager.domainKey];
        ...
        body:SafeArea(
            child: Obx(()=>controller.isLoading.value?const Center(child:Loading(),):Stack(
              children: [
                ...
                showSignup?didnotHaveAnyAccount():const Text('')
              ],
  ...
  Widget _buildEmailTF(String _emailSuf) {
    return Column(
      ...
      children:  [
        ...
        _emailTextField(_emailSuf)

      ],
    );
  }
  Widget _emailTextField(String _emailSuf){
    return Container(
      ...
      child: TextFormField(
        ...
        validator:(value){
          return controller.validateEmail(value!+_emailSuf);
        },
        onSaved: (value){
    ...
    return Padding(
      ...
      child: Material(  //Wrap with Material
        ...
        child: MaterialButton(
          ...
          onPressed: ()=>controller.checkRegistration(),
        ),
      ),
    );
  }

  Widget didnotHaveAnyAccount(){
    return Align(
